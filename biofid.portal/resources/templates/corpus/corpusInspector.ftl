...
<div>
    <div class="cheader w-100 flexed align-items-center justify-content-between p-4">
        ...
        <div class="text-center">
            ...
            <p class="text mb-0 font-italic">Korpus-Überblick</p>
        </div>
    ...
    <div class="ccontent">
        ...
        <!-- Meta -->
        <h5 class="mb-3 text-center color-prime">Meta</h5>
        <div class="row m-0 p-0 border rounded">
            ...
            <div class="col-lg-6 entry">
                <label class="mb-0 pr-3 pl-3 text">Quelle</label>
                <input readonly type="text" class="form-control rounded-0" value="${corpus.getAuthor()}"/>
            </div>

            <div class="col-lg-6 entry">
                <label class="mb-0 pr-3 pl-3 text">Sprache</label>
                <input readonly type="text" class="form-control rounded-0" value="${corpus.getLanguage()}"/>
            </div>

            <div class="col-lg-6 entry">
                <label class="mb-0 pr-3 pl-3 text">Importiert</label>
                <input readonly type="text" class="form-control rounded-0" value="${corpus.getCreated()}"/>
            </div>
        </div>

        <!-- Annotations -->
        <h5 class="mb-3 mt-3 text-center color-prime">Annotations</h5>
        <div class="row m-0 pl-0 pr-0 border rounded">
