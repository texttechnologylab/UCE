        ...
        <div class="mt-2 mb-2 w-100 p-0 m-0 justify-content-center flexed align-items-start">
            <div class="group-box bg-light">
                ...
                <div class="expanded-content mt-3 display-none">
                    ...
                    <div class="mb-4 group-box">
                        ...
                        <div>
                            <p class="text mb-1">Examines each token or joined phrase and performs a string comparison
                                to
                                identify any existing alternative names (vernacular, synonym, subspecies, etc.). If
                                alternatives are found, they are
                    ...
                    <!-- Taxon Commands -->
                    <div class="group-box">
                        <label class="color-secondary font-weight-bold">Taxon Commands
                            <i class="text">&lt;RANK&gt;::&lt;NAME&gt;</i></label>
                        <div>
                            <p class="text">
                                Taxon Commands allow users to embed specific ranks within the search query using
                                a predefined syntax.
                                ...
                                <li class="mt-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text mb-2 mt-2">
                                            These commands also work in combination with the logical operators and any
                                            other command.
                                        </p>
                                        <div class="flexed align-items-center">
                                            <label class="mb-0 mr-2">Example:</label>
                                ...
                                <li class="mt-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="flexed align-items-center">
                                            <label class="mb-0 mr-2">Example:</label>
                                            <p class="w-100 p-2 rounded mb-0 bg-default text light-border">
                                                <i><b class="color-prime">LOC::</b>H.CNL</i>
                                                <i class="fas fa-long-arrow-alt-right ml-1 mr-1"></i>
                                                <span class="color-prime">( 'Aarkanaal' | 'Aušrelis' | 'Chornomorskyi Kanal' | <i>[...]</i> )</span>
                                            </p>
                                        </div>
                                        <p class="text mb-2 mt-2">
                                            These commands also work in combination with the logical operators and any
                                        ...
                                        <div class="flexed align-items-center">
                                            <label class="mb-0 mr-2">Example:</label>
                                            <p class="w-100 p-2 rounded mb-0 bg-default text light-border">
                                                <i><b class="color-prime">LOC::</b>H.CNL & Tabel:*</i>
                                                <i class="fas fa-long-arrow-alt-right ml-1 mr-1"></i>
                                                <span class="color-prime">( 'Aarkanaal' | 'Aušrelis' | <i>[...]</i> ) <b
                                                            class="color-prime">&</b> Tabel:*</span>
                                            </p>
                                        </div>
                                        <p class="text mt-1">
                                            The command also works without declaring a feature code, e.g. <i>LOC::H</i>.
                                        </p>
                                    </div>
                                </li>
                                <li class="mt-2">
                                    ...
                                    <div>
                                        <div class="flexed align-items-center justify-contente-between mb-2">
                                            <p class="text w-100 mr-1">
                                                Retrieves all locations that have been imported with the corpus that are
                                                within the given 2D area, defined
                                                by its middle point (lat/lng) and the given radius in <b>meters</b>.
                                            </p>
                                            <img class="w-100 light-border ml-1" style="max-width: 175px"
                                                 src="/img/search-radius-example.png"/>
                                        </div>
                                        <div class="flexed align-items-center">
                                            <label class="mb-0 mr-2">Example:</label>
                                            <p class="w-100 p-2 rounded mb-0 bg-default text light-border">
                                                <i><b class="color-prime">R::</b>lng=9;lat=50;r=70000</i>
                                                <i class="fas fa-long-arrow-alt-right ml-1 mr-1"></i>
                                                <span class="color-prime">( 'Affolterbach' | 'Altenburg' | 'Altenhaßlau' | <i>[...]</i> )</span>
                                            </p>
                                        </div>
                                        <p class="text mb-2 mt-2">
                                            These commands also work in combination with the logical operators and any
                    ...
                    <div class="group-box">
                        ...
                        <div>
                            <p class="text">
                                Time Commands allow users to embed specific times and dates within the search query using
                                a predefined syntax.
                                These commands are resolved with relevant data for the query.
                                The general syntax is <i>&lt;CODE&gt;::&lt;VALUE&gt;</i>, and the available commands are
                                listed below:
                            </p>
                            <ul>
                                <li class="mt-2">
                                    <label class="color-secondary font-weight-bold font-italic">Y:: <i
                                                class="text">(year)</i></label>
                                    <div>
                                        <p class="text mb-1">
                                            Interprets the phrase following <i>Y::</i> as a specific year in form of a number.
                                        </p>
                                        <div class="flexed align-items-center">
                                            <label class="mb-0 mr-2">Example:</label>
                                            <p class="w-100 p-2 rounded mb-0 bg-default text light-border">
                                                <i><b class="color-prime">Y::</b>1880</i>
                                                <i class="fas fa-long-arrow-alt-right ml-1 mr-1"></i>
                                                <span class="color-prime">( '1880' | '1. September 1880' | 'Ende Juli 1880' | <i>[...]</i> )</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <ul>
                                <li class="mt-2">
                                    <label class="color-secondary font-weight-bold font-italic">T:: <i
                                                class="text">(year - year)</i></label>
                                    <div>
                                        <p class="text mb-1">
                                            Interprets the phrase following <i>T::</i> as a specific <b>range</b> of years.
                                        </p>
                                        <div class="flexed align-items-center">
                                            <label class="mb-0 mr-2">Example:</label>
                                            <p class="w-100 p-2 rounded mb-0 bg-default text light-border">
                                                <i><b class="color-prime">T::</b>1880-1900</i>
                                                <i class="fas fa-long-arrow-alt-right ml-1 mr-1"></i>
                                                <span class="color-prime">( '1880' | '10. Juli 1896' | '23.9.1889' | <i>[...]</i> )</span>
                                            </p>
                                        </div>
                                        <p class="text mb-2 mt-2">
                                            These commands also work in combination with the logical operators and any
        ...
        <div class="group-box bg-light">
            ...
            <div class="expanded-content mt-3 display-none">
                ...
                <div class="mb-4 group-box">
                    ...
                    <div>
                        <p class="text mb-1">Layers represent different stages of filtering, applied sequentially from
                            top (first layer)
                            to bottom (last layer). The first layer filters the entire corpus, while each subsequent
                            layer applies
                        ...
                        <p class="text">
                            ...
                            The second layer further refines this filtered data pool by selecting only texts that
                            contain the taxon Alpina.
                        </p>
                ...
                <div class="mb-4 group-box">
                    ...
                    <div>
                        <p class="text mb-1">A slot represents a sub-unit of a layer, allowing a single layer to contain
                            multiple slots.
                            Each slot defines a specific filtering condition based on its type, which corresponds to an
                            annotation.
                            A slot of type <b>Time</b> applies a time-based filter to the data pool.
                            Slots of type <b>Location</b> and <b>Taxon</b> apply location-based and taxonomic filters,
                            respectively.
                            Each slot utilizes the corresponding annotations and supports specific commands, which are
                            listed below.
                            Within a layer, slots are concatenated using a logical OR operator.
                            As a result, a layer with multiple slots increases the likelihood of retrieving a larger
                            data pool.
                        </p>
                        <hr class="mt-2 mb-2"/>
                        <p class="text">
                            ...
                            This expands the data pool to include texts that either contain "Germany" or are annotated
                            with a time range between 1800 and 1900.
                            The second layer then further filters this pool by selecting only texts that contain the
                            specified annotated taxon.
                        </p>
